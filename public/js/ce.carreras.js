...
/***/ "./resources/js/components/ce.carreras.jsx":
/*!*************************************************!*\
  !*** ./resources/js/components/ce.carreras.jsx ***!
  \*************************************************/
/*! no exports provided */
...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function getApiData(e, url, prop) {
      ...
      var paramsCustom = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
      axios.get(url, {
        params: paramsCustom !== null ? paramsCustom : {
          q: e ? e.target.value : ""
        }
      }).then(function (data) {
    ...
    key: "updItem",
    value: function updItem(id, type) {
      var _this3 = this;
      ...
      if (val !== null && val !== "") {
        ...
        axios.put(url, obj).then(function (data) {
          console.log(data);

          _this3.getApiData(null, "/controlEstudios/carreras", "carreras");
    ...
    key: "delItem",
    value: function delItem(id, type) {
      var _this4 = this;
      ...
      if (confirm("¿Realmente quiere eliminar?")) {
        ...
        axios["delete"](url, obj).then(function (data) {
          console.log(data);

          _this4.getApiData(null, "/controlEstudios/carreras", "carreras");
        })["catch"](function (error) {
          return console.log(error);
        });
      }
    ...
    value: function addItem(type) {
      ...
      switch (type) {
        case "carrera":
          url = "/controlEstudios/carrera";
          obj = {
            nombreCarrera: this.state.nombreCarrera
          };
          break;
      ...
      axios.post(url, obj).then(function (data) {
        ...
        _this5.getApiData(null, "/controlEstudios/carreras", "carreras");
      })["catch"](function (error) {
        return console.log(error);
      });
    }
    ...
    value: function changeUniqueState(newState) {
      ...
      return new Promise(function (solve) {
        return _this6.setState(newState, solve);
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var _this$state = this.state,
          ...
          nombreCarrera = _this$state.nombreCarrera,
          nombreCategoria = _this$state.nombreCategoria,
          nombreUc = _this$state.nombreUc,
...
/***/ 2:
/*!*******************************************************!*\
  !*** multi ./resources/js/components/ce.carreras.jsx ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\uptaapc\resources\js\components\ce.carreras.jsx */"./resources/js/components/ce.carreras.jsx");
