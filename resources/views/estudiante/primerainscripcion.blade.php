...
<form action="{{ route('primerainscripcion.store') }}" method="post" enctype="multipart/form-data">
    @csrf
        ...
        <div class="container">
               ...
               <div class="col-md-3">
                    ...
                    <div class="form-group">
                       <div class="form-check form-check-inline">
                          <input {{ isset($data)?$data->trabaja==1?"checked":"":old("trabaja")==1?"checked":"checked" }} type="radio" class="form-check-input autoHide" data-handle="trabaja" data-hideval="0" data-class="l_trabajoHide" id="trabajasi" name="trabaja" value="1">
                          <label class="form-check-label" for="trabajasi">Sí</label>
                        </div>

                        <!-- Material inline 2 -->
                        <div class="form-check form-check-inline">
                          <input {{ isset($data)?$data->trabaja==0?"checked":"":old("trabaja")==0?"checked":null }} type="radio" class="form-check-input autoHide" data-handle="trabaja" data-hideval="0" data-class="l_trabajoHide" id="trabajano" name="trabaja" value="0" >
                          <label class="form-check-label" for="trabajano">No</label>
                        </div>
                    </div>
               </div>
               <div class="col-md-9">
                   <div class="form-group l_trabajoHide" style="display: none;">
                        <label for="l_trabajo">Lugar de trabajo</label>
                        <input type="text" id="l_trabajo" name="l_trabajo" placeholder="Por ejemplo, UPTAAPC" class="form-control" value="{{ isset($data)?$data->l_trabajo:old('l_trabajo') }}">
                    </div>
               </div>
           </div>
           <div class="row">
           ...
           <div class="row">
               <div class="col">
                  ...
                  <h3 class="text-muted">Foto tipo carnet</h3>
                  <div class="form-group" class="mb-3">
                      <i class="fa fa-file-image-o" aria-hidden="true"></i>
                      <input type="file" required name="file_foto" value="{{ old('file_foto') }}">
                  </div>
                  <br>

                  <h3 class="text-muted">Fondo negro del título</h3>
                  <div class="form-group" class="mb-3">
                    <i class="fa fa-newspaper-o" aria-hidden="true"></i>
                    <input type="file" required name="file_fondo_negro" value="{{ old('file_fondo_negro') }}">
                  </div>
                  <br>

                  <h3 class="text-muted">Notas certificadas</h3>
                  <div class="form-group" class="mb-3">
                    <i class="fa fa-paperclip" aria-hidden="true"></i>
                    <input type="file" required name="file_notas" value="{{ old('file_notas') }}">
                  </div>
                  <br>
